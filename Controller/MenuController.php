...
class MenuController extends Controller
{
     ...
     * @return Response
     */
    public function topMenuAction($currentLocationId = null, $bundle = 'xrowbootstrapBundle')
    {
        ...
        return $this->render($bundle.'::page_topmenu.html.twig', $parameters, $response);
    }
...
class MenuController extends Controller
{
    ...
    public function breadcrumbAction($locationId, $bundle = 'xrowbootstrapBundle')
    {
        /** @var WhiteOctober\BreadcrumbsBundle\Templating\Helper\BreadcrumbsHelper $breadcrumbs */
        $breadcrumbs = $this->get("white_october_breadcrumbs");
